							...
							<div id="slideshow_container">
								<div class="csslider infinity" id="slider1">
								  ...
								  <ul>
								    ...
								    <li class="scrollable">
								      <h1>HUmbrella</h1>
								      <h2>Handy Umbrella</h2>
								      <p>
								        Handy Umbrella is the most comfortable umbrella in the world... If you just want all possible comfort givable from an umbrella, special material we offer to you will give the real Aeden. You can find ergonimical grips if you have any issue. Or, if you just like vintage style, umbrella shown here is what you really want.
								      </p>
					...
					<form action="/addItem.php" method="POST">
						<div class="col-5 col-sm-5 left sm-center">
							...
							<div class="col-5 col-sm-2">
								<h3>Bluetooth:</h3>
								<div class="col-10 col-sm-5" data-toggle="buttons">
								    <input type="radio" <?php tabIndex(); ?> name="options_bt" id="b1" checked="checked" value="1" />
							...
							<div class="col-5 col-sm-2 offset-sm-1">
								<h3>PH analyzer:</h3>
								<div class="col-10 col-sm-5" data-toggle="buttons">
								    <input type="radio" <?php tabIndex(); ?> name="options_ph" id="p1" checked="checked" value="0" />
							...
							<div class="col-5 col-sm-2">
								<h3>GPS:</h3>
								<div class="col-10 col-sm-5" data-toggle="buttons">
									<input type="radio" <?php tabIndex(); ?> name="options_gps" id="g2" checked="checked" value="0" />
							...
							<div class="col-5 col-sm-2 offset-sm-1">
								<h3>Solar panels:</h3>
								<div class="col-10 col-sm-5" data-toggle="buttons">
									<input type="radio" <?php tabIndex(); ?> name="options_solar" id="s2" checked="checked" value="0" />
                            ...
                            <div class="col-5 col-sm-2">
								<h3>Touch ID:</h3>
								<div class="col-10 col-sm-5" data-toggle="buttons">
								    <input type="radio" <?php tabIndex(); ?> name="options_id" id="id1" checked="checked" value="1" />
                            ...
                            <div class="col-5 col-sm-2 offset-sm-1">
								<h3>Total amount:</h3>
								<div class="col-10 col-sm-5">
								    <input type="radio" name="name" id="name" checked="checked" value="HUmbrella" />
                            		<input type="radio" name="price" id="price" checked="checked" value="150" />
                            		<label for="price" id="price_label">150 $</label>
								</div>
							</div>
						</div>
						<?php 
